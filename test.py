...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_num', help='image number to automatically set paths')
    ...
    # If img_num is provided, set the paths automatically
    if args.img_num:
        base_path = "dataset/demo_data/test/"
        args.pc_path = os.path.join(base_path, f"{args.img_num}.bin")
        args.calib_path = os.path.join(base_path, f"{args.img_num}.txt")
        args.img_path = os.path.join(base_path, f"{args.img_num}.png")
